...
export const leadsInfoContent: InfobarContent = {
  title: 'Leads — React Query + nuqs Pattern',
  sections: [
    {
      title: 'Overview',
      description:
    ...
    {
      title: 'Products vs Leads Pattern',
      description:
        'Products: searchParams → RSC fetch → pass data as props to client table. Leads: searchParams → server prefetch → HydrationBoundary → client useSuspenseQuery. The Leads pattern enables background refetching, cache sharing across components, and optimistic mutations.',
      links: []
    }
  ]
};
