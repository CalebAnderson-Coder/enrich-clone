...
function AppAuthed({ signOut }) {
  ...
  const suspenseWrapper = (Component) => (
    <Suspense fallback={<div className="flex-1 overflow-y-auto h-full flex items-center justify-center text-surface-400">cargando…</div>}>
      {Component}
    </Suspense>
  );
  ...
  const renderMainContent = () => {
    switch (currentView) {
      case 'cockpit': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<CockpitView />)}</div>;
      case 'newsroom': return <div className="flex-1 overflow-y-auto h-full p-6">{suspenseWrapper(<NewsroomView />)}</div>;
      case 'heartbeat': return <div className="flex-1 overflow-y-auto h-full p-6">{suspenseWrapper(<HeartbeatWallView />)}</div>;
      case 'pipeline': return <div className="flex-1 overflow-y-auto h-full p-6">{suspenseWrapper(<PipelineFlowView />)}</div>;
      case 'quality': return <div className="flex-1 overflow-y-auto h-full p-6">{suspenseWrapper(<QualityTrendView />)}</div>;
      case 'atlas': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<AtlasView />)}</div>;
      case 'replies': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<RepliesInboxView />)}</div>;
      case 'ghl': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<GHLView />)}</div>;
      case 'leads': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<LeadsView />)}</div>;
      case 'performance': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<PerformanceView />)}</div>;
      case 'campaign': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<CampaignView />)}</div>;
      case 'calendar': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<CalendarView />)}</div>;
      case 'files': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<FilesView />)}</div>;
      case 'profile': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<ProfileView />)}</div>;
      case 'integrations': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<IntegrationsView />)}</div>;
      case 'history': return <div className="flex-1 overflow-y-auto h-full">{suspenseWrapper(<HistoryView />)}</div>;
      case 'chat':
      default:
        return (
