              ...
              <div key={lead.id} className="lead-card">
                ...
                <div className="lead-meta">
                  ...
                  {lead.phone && (
                    <div className="meta-row phone">
                      ...
                      <LinkCell url={phoneLink} type="phone" label={lead.phone} />
                    </div>
                  )}

                  {lead.email && (
                    <div className="meta-row email">
                      <LinkCell url={`mailto:${lead.email}`} type="email" label={lead.email} truncate={40} />
                    </div>
                  )}
                ...
                <div className="lead-contact-channels">
                  ...
                  <div className="outreach-action-row">
                    ...
                    <Link
                      to={`/leads/${lead.id}`}
                      className="review-outreach-btn"
                      style={{ background: 'rgba(96,165,250,0.12)', color: '#60a5fa', textDecoration: 'none' }}
                    >
                      Abrir detalle →
                    </Link>
